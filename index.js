...
// Header 
  // Logo
  // Navigation (header links, user icon)
// Main area
  // search bar, filter
...
const Header = () => {
  return (
    <header className="header">
      <img className="logo" src="https://st2.depositphotos.com/40002406/42721/v/450/depositphotos_427216920-stock-illustration-food-delivery-logo-template-design.jpg" alt="Own Delivery App" />
...
const RestaurantCard = (pro) => {
  ...
  return (
    <div className="res-card">
      {/* <img className="res-image" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/fa4944f0cfdcbca2bec1f3ab8e3db3f7" alt="resaurant" /> */}
      <img className="res-image" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_292,h_300/"+cloudinaryImageId}  alt="resaurant" />
      <h3>{name}</h3>
      <h4>{cuisines.join(', ')}</h4>
